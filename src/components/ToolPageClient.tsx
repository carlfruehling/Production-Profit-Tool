  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-blue-50 to-white">
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col items-start sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-[#00AAAA] whitespace-nowrap flex items-center gap-2"><Image src="/icon.svg" alt="" width={28} height={28} />Produktions-Profit-Tool</h1>
